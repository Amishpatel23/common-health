...
const BookSession = () => {
  ...
  if (isLoading) {
    return (
      <DashboardLayout title="Loading..." showBackButton={false}>
  ...
  if (!trainer) {
    return (
      <DashboardLayout title="Trainer Not Found" showBackButton={false}>
  ...
  return (
    <DashboardLayout 
      title={`Book Session with ${trainer.name}`} 
      description="Select a date and time for your training session"
      showBackButton={true}
    >
      <div 
        className={`${
